...
score_msg = score_font.render("Счет:",1,pygame.Color("green"))
score_msg_size = score_font.size("Счет")
...
def endGame():
    message = game_over_font.render("ПОТРАЧЕНО",1,pygame.Color("white"))
    message_play_again = play_again_font.render("Сыграть снова? Y/N",1,pygame.Color("green"))
...
def drawGameTime(gameTime):
    game_time = score_font.render("Время:",1,pygame.Color("green"))
    game_time_numb = score_numb_font.render(str(gameTime/1000),1,pygame.Color("red"))
    screen.blit(game_time,(30,10))
    screen.blit(game_time_numb,(150,14))
